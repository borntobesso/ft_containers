...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/04 14:24:04 by soyoungjung       #+#    #+#             */
/*   Updated: 2022/12/12 15:55:42 by sojung           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void vector_test(void)
{
    ...
    std::vector<int> default_int;
    print_vector(default_int);
    std::vector<char> default_char;
    print_vector(default_char);
    std::vector<std::string> default_str;
    print_vector(default_str);
    std::cout << ">> Fill constructor" << std::endl;
    std::vector<int> fill_int(5, 42);
    print_vector(fill_int);
    std::vector<char> fill_char(10, 'c');
    print_vector(fill_char);
    try
    {
        std::vector<char> fill_char_err(-5, 'c');
    ...
    std::vector<std::string> fill_str(42, "42");
    print_vector(fill_str);
    std::vector<std::string> fill_str_zero(0, "42");
    print_vector(fill_str_zero);
    std::cout << ">> Range constructor" << std::endl;
    std::vector<int> ref_int_vec(20, 100);
    std::vector<int> range_int(ref_int_vec.begin(), ref_int_vec.end());
    print_vector(range_int);
    std::vector<int> range_int_err(ref_int_vec.begin(), ref_int_vec.begin() + 10);
    print_vector(range_int_err);
    std::cout << ">> Copy constructor" << std::endl;
    std::vector<int> copy_int(range_int);
    print_vector(copy_int);
    std::vector<char> copy_char(std::vector<char>(5, 'a'));
    print_vector(copy_char);
    std::cout << ">> Assignment operator" << std::endl;
    std::vector<int> assign_int;
    assign_int = copy_int;
    ...
    const std::vector<int> const_vec(assign_int);
    ...
    std::vector<char> alpha_vec;
    for (size_t i = 0; i < 5; i++)
        alpha_vec.push_back('A' + i);
    const std::vector<char> const_alpha_vec(alpha_vec.begin(), alpha_vec.end());
    for (size_t i = 0; i < 5; i++)
    ...
    std::cout << "Time taken by std::vector is : "
