...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/09 15:28:08 by soyoungjung       #+#    #+#             */
/*   Updated: 2022/12/12 15:29:54 by sojung           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void map_test(void)
{
	...
	std::map<char, int> default_char;
	print_map(default_char);
	std::map<int, int> default_int;
	print_map(default_int);
	std::map<std::string, char> default_str;
	print_map(default_str);
	std::cout << ">> Range constructor" << std::endl;
	default_char.insert(std::pair<char, int>('Q', 1));
	default_char.insert(std::pair<char, int>('W', 2));
	default_char.insert(std::pair<char, int>('E', 3));
	default_char.insert(std::pair<char, int>('R', 4));
	default_char.insert(std::pair<char, int>('T', 5));
	default_char.insert(std::pair<char, int>('Y', 6));
	std::map<char, int> range_char(default_char.begin(), default_char.end());
	print_map(range_char);
	std::map<char, int> range_char2(default_char.rbegin(), default_char.rend());
	print_map(range_char2);
	std::cout << ">> Copy constructor" << std::endl;
	default_str.insert(std::pair<std::string, char>("hi", 'a'));
	default_str.insert(std::pair<std::string, char>("coffee", 'b'));
	default_str.insert(std::pair<std::string, char>("hello", 'c'));
	default_str.insert(std::pair<std::string, char>("good", 'd'));
	default_str.insert(std::pair<std::string, char>("abc", 'e'));
	std::map<std::string, char> range_str(default_str);
	print_map(range_str);
	std::cout << ">> Assignment operator" << std::endl;
	default_int.insert(std::pair<int, int>(12, 1));
	default_int.insert(std::pair<int, int>(3, 2));
	default_int.insert(std::pair<int, int>(4, 3));
	default_int.insert(std::pair<int, int>(56, 4));
	default_int.insert(std::pair<int, int>(7, 5));
	default_int.insert(std::pair<int, int>(89, 6));
	default_int.insert(std::pair<int, int>(0, 7));
	std::map<int, int> assign_int;
	assign_int = default_int;
	print_map(assign_int);

	std::cout << "## Iterator & reverse iterator test ##" << std::endl;
	std::map<std::string, char>::iterator it1 = default_str.begin();
	std::map<std::string, char>::iterator it2 = default_str.end();
	...
	std::map<char, int>::reverse_iterator rit1 = default_char.rbegin();
	std::map<char, int>::reverse_iterator rit2 = default_char.rend();
	...
	std::map<int, int>::value_type *alloc1 = default_int.get_allocator().allocate(1);
	std::cout << sizeof(alloc1) << std::endl;
	std::map<char, int>::value_type *alloc2 = default_char.get_allocator().allocate(1);
	...
	std::map<char, int>::key_compare key_cmp1 = default_char.key_comp();
	std::map<char, int>::value_compare val_cmp1 = default_char.value_comp();
	...
	std::map<std::string, char>::key_compare key_cmp2 = default_str.key_comp();
	std::map<std::string, char>::value_compare val_cmp2 = default_str.value_comp();
	...
	std::map<char, int>::iterator char_ptr = default_char.find('Q');
	...
	if (char_ptr == default_char.end())
		...
		std::cout << "key : " << (*char_ptr).first << " value : " << (*char_ptr).second << std::endl;
	std::map<std::string, char>::iterator str_ptr = default_str.find("abc");
	...
	std::pair<std::map<char, int>::iterator, std::map<char, int>::iterator> char_pair;
	...
	std::pair<std::map<std::string, char>::iterator, std::map<std::string, char>::iterator> str_pair;
	...
	res = default_char.insert(std::pair<char, int>('A', 6));
	std::cout << "inserted element key : " << res.first->first << std::endl;
	std::cout << "is insert successful : " << res.second << std::endl;
	res = default_char.insert(std::pair<char, int>('S', 7));
	std::cout << "inserted element key : " << res.first->first << std::endl;
	std::cout << "is insert successful : " << res.second << std::endl;
	res = default_char.insert(std::pair<char, int>('D', 8));
	std::cout << "inserted element key : " << res.first->first << std::endl;
	std::cout << "is insert successful : " << res.second << std::endl;
	res = default_char.insert(std::pair<char, int>('F', 9));
	std::cout << "inserted element key : " << res.first->first << std::endl;
	std::cout << "is insert successful : " << res.second << std::endl;
	res = default_char.insert(std::pair<char, int>('Q', 1));
	std::cout << "inserted element key : " << res.first->first << std::endl;
	std::cout << "is insert successful : " << res.second << std::endl;
	res = default_char.insert(std::pair<char, int>('W', 1));
	std::cout << "inserted element key : " << res.first->first << std::endl;
	std::cout << "is insert successful : " << res.second << std::endl;
	print_map(default_char);

	std::cout << ">> Unique insert with hint" << std::endl;
	std::map<std::string, char>::iterator res2;
	res2 = default_str.insert(++(default_str.begin()), std::pair<std::string, char>("cheer", 33));
	std::cout << "inserted element key : " << res2->first << std::endl;
	res2 = default_str.insert(default_str.begin(), std::pair<std::string, char>("up!", 13));
	std::cout << "inserted element key : " << res2->first << std::endl;
	res2 = default_str.insert(--(default_str.end()), std::pair<std::string, char>("friend", 42));
	std::cout << "inserted element key : " << res2->first << std::endl;
	print_map(default_str);

	std::cout << ">> Range insert" << std::endl;
	std::map<std::string, char> new_str;
	std::map<std::string, char>::iterator median_pos = default_str.find("good");
	...
	std::map<std::string, char>::size_type res_erase = new_str.erase("hello");
	...
	print_map(default_str);
	print_map(new_str);
	std::map<std::string, char> empty_str;
    ...
    std::cout << "Time taken by std::map is : "
